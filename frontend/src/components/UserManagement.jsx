  ...
  return (
    <div className={`min-h-screen transition-all duration-500 ${
      ...
      <div className="max-w-7xl mx-auto">
        ...
        {/* Filters and Actions */}
        <div className={`p-4 rounded-xl border backdrop-blur-xl mb-6 ${
          isDark ? 'bg-gray-800/80 border-gray-700/50' : 'bg-white/80 border-white/50'
        } shadow-lg`}>
        ...
        {/* Users Table */}
        <div className={`rounded-xl border backdrop-blur-xl shadow-lg overflow-hidden ${
          isDark ? 'bg-gray-800/80 border-gray-700/50' : 'bg-white/80 border-white/50'
        }`}>
        ...
        {showAddUser && (
          <div className="fixed inset-0 bg-black/50 backdrop-blur-sm flex items-center justify-center z-50">
            <div className={`p-6 rounded-2xl border shadow-2xl max-w-md w-full ${
              isDark ? 'bg-gray-800/95 border-gray-700' : 'bg-white/95 border-white/50'
            } backdrop-blur-xl`}>
